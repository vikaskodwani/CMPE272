...
if (isset($id)) {
    if ($id == 1) {
        ...
        $content = get_data('http://www.absolutestop.com/market-place.php');
    }
}
...
<head>
    ...
    <title>Product Details || Minoan</title>
                        ...
                        <div class="header-top-right">
                            <div>
                                <?php if(isset($_SESSION['user'])){ ?>
                                    <p><a class="header-link" href="logout.php?logout" style="text-decoration:none">  Sign Out</a>
                                        <?php echo "Hello, ";?><?php print_r($_SESSION['user']);?>!</p>
                                <?php }else{ ?>
                                    <p><a class="header-link" href="my-account.php" style="text-decoration:none">Sign In </a>Hello, User!</p>
                                <?php } ?>
                            </div>
                            <!-- Header Social Icon -->
                        ...
                        <ul class="main-ul">
                            ...
                            <li class="sub-menu-li"><a href="#" class="new-arrivals">Pages<i class="fa fa-chevron-down"></i></a>
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="product-details.php"><i class="fa fa-chevron-circle-right"></i> <span>Product Details</span></a></li>
