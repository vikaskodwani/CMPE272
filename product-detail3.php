...
if(!isset($_COOKIE['visitedcountproduct3'])){
    ...
    setcookie("visitedcountproduct3",$cookie);
   // echo $_COOKIE['visitedcountproduct3'];
}
...
/// echo "<h1> Value is</h1>".$_COOKIE['count'];
...
<head>
    ...
    <link href="dist/toolkit-minimal3.css" rel="stylesheet">
    <link href="dist/application-minimal3.css" rel="stylesheet">
    ...
    <div class="product-content product-wrap clearfix product-deatil">
        <div class="row">
            ...
            <div class="col-md-7 col-sm-12 col-xs-12">
                ...
                <h2 class="name">
                    Calendar app
                    <small>Product by <a href="javascript:void(0);">vladyno</a></small>
...
<script src="dist/toolkit3.js"></script>
<script src="dist/application3.js"></script>
